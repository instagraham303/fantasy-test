...
Best_magazine_frontend_functions::wpb_set_post_views($post->ID);// most populiar
	...
	<div id="content">
				...
				if ( has_post_thumbnail()) { ?>
					  <div class="post-thumbnail-div">
						<div class="img_container unfixed">
							<?php echo Best_magazine_frontend_functions::auto_thumbnail(false); ?>
						</div> 
					 </div>
		...
		<?php } }  ?>
				...
				<div class="entry-meta">
					  <?php Best_magazine_frontend_functions::posted_on_single(); ?>
				</div>
				<?php Best_magazine_frontend_functions::entry_meta_cat(); }?>
				...
				Best_magazine_frontend_functions::post_nav(); ?>
				<div class="clear"></div>
