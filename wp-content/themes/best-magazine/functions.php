...
/* excerpt more */
add_filter('excerpt_more', array('Best_magazine_frontend_functions', 'excerpt_more'));
/*   remove more in posts and pages   */
add_filter('the_content_more_link', array('Best_magazine_frontend_functions', 'remove_more_jump_link'));
...
add_action('woocommerce_before_main_content', array('Best_magazine_frontend_functions', 'wdwt_wrapper_start'), 10);
add_action('woocommerce_after_main_content', array('Best_magazine_frontend_functions', 'wdwt_wrapper_end'), 10);
