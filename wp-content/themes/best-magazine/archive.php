	...
	<?php $post = $posts[0]; ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post">
				...
				<?php if($date_enable){ ?>
					<p class="meta-date"><?php _e('By ',"best-magazine"); ?><?php the_author_posts_link(); ?> | <?php Best_magazine_frontend_functions::posted_on(); ?></p>
				<?php } ?>		
			</div>
        ...
        <?php if($date_enable) Best_magazine_frontend_functions::entry_meta(); ?>
		<?php endwhile; ?>
